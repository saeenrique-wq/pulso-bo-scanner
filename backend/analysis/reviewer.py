...
MIN_SCORE    = 22   # Ollama AI hace el filtro fino — aquí solo filtramos basura total
MIN_PAYOUT   = 0.80
COOLDOWN_S   = 90   # 1.5 min entre señales del mismo par+dirección
MAX_DAY_ASSET = 20  # máx señales/activo/día
